        ...
        <div class="topbar-inner">
          ...
          <div class="topbar-actions">
            ...
            <details class="mobile-nav-shell">
              <summary class="mobile-menu-toggle" aria-label={ui.mobileMenuOpen}>
              ...
              <label class="mobile-nav-backdrop" aria-hidden="true" />
              ...
              <div class="mobile-nav-drawer">
                <div class="mobile-nav-header">
                  <div class="mobile-nav-brand">
                    ...
                    <div>
                      <p class="eyebrow">{ui.appName}</p>
                      <p class="mobile-nav-title">{ui.mobileMenuLabel}</p>
                    </div>
                  </div>

                  <summary class="mobile-nav-close" aria-label={ui.mobileMenuClose}>
                ...
                <nav class="nav nav-mobile" aria-label="Main">
                  ...
                  <Link href="/profile" class={navItemClass(profileActive)} aria-current={profileActive ? "page" : undefined}>
                    <span class="nav-icon" aria-hidden="true">
                      <svg viewBox="0 0 24 24" role="presentation">
