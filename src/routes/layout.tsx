        ...
        <div class="topbar-inner">
          ...
          <div class="topbar-actions">
            ...
            <details class="mobile-menu-shell">
              <summary class="mobile-menu-trigger" aria-label={ui.mobileMenuOpen}>
              ...
              <summary class="mobile-menu-backdrop" aria-label={ui.mobileMenuClose} />
              ...
              <aside class="mobile-menu-drawer" aria-label={ui.mobileMenuLabel}>
                <div class="mobile-menu-head">
                  ...
                  <summary class="mobile-menu-close" aria-label={ui.mobileMenuClose}>
                ...
                <nav class="mobile-menu-list" aria-label="Main">
                  <a href="/" class={mobileMenuItemClass(homeActive)} aria-current={homeActive ? "page" : undefined}>
                    <span class="mobile-menu-item-icon" aria-hidden="true"><svg viewBox="0 0 24 24" role="presentation"><path d="M3.75 10.5 12 3.75l8.25 6.75v8.25a1.5 1.5 0 0 1-1.5 1.5h-4.5v-6h-4.5v6h-4.5a1.5 1.5 0 0 1-1.5-1.5z" /></svg></span>
                    <span class={mobileMenuLabelClass(homeActive)}>{ui.navHome}</span>
                  </a>
                  <a href="/feed" class={mobileMenuItemClass(feedActive)} aria-current={feedActive ? "page" : undefined}>
                    <span class="mobile-menu-item-icon" aria-hidden="true"><svg viewBox="0 0 24 24" role="presentation"><rect x="4.5" y="4.5" width="15" height="15" rx="4" ry="4" /><circle cx="12" cy="12" r="2.25" /><path d="M16.875 7.125h.01" /></svg></span>
                    <span class={mobileMenuLabelClass(feedActive)}>{ui.navFeed}</span>
                  </a>
                  <a href="/vocabulary/" class={mobileMenuItemClass(vocabularyActive)} aria-current={vocabularyActive ? "page" : undefined}>
                    <span class="mobile-menu-item-icon" aria-hidden="true"><svg viewBox="0 0 24 24" role="presentation"><path d="M5.25 5.25h9a2.25 2.25 0 0 1 2.25 2.25v11.25H7.5a2.25 2.25 0 0 0-2.25 2.25z" /><path d="M7.5 5.25v15.75" /><path d="M18.75 7.5v11.25H9.75" /></svg></span>
                    <span class={mobileMenuLabelClass(vocabularyActive)}>{ui.navVocabulary}</span>
                  </a>
                  <a href="/language-map/" class={mobileMenuItemClass(mapActive)} aria-current={mapActive ? "page" : undefined}>
                    <span class="mobile-menu-item-icon" aria-hidden="true"><svg viewBox="0 0 24 24" role="presentation"><circle cx="6.75" cy="6.75" r="2.1" /><circle cx="17.25" cy="6.75" r="2.1" /><circle cx="12" cy="17.25" r="2.1" /><path d="m8.7 7.8 2.55 7.65" /><path d="m15.3 7.8-2.55 7.65" /><path d="M8.7 6.75h6.6" /></svg></span>
                    <span class={mobileMenuLabelClass(mapActive)}>{ui.navMap}</span>
                  </a>
                  <a href="/quests/" class={mobileMenuItemClass(questsActive)} aria-current={questsActive ? "page" : undefined}>
                    <span class="mobile-menu-item-icon" aria-hidden="true"><svg viewBox="0 0 24 24" role="presentation"><path d="M7.5 4.5h9l3 3v12a1.5 1.5 0 0 1-1.5 1.5h-12A1.5 1.5 0 0 1 4.5 19.5v-12z" /><path d="M16.5 4.5v4.5h4.5" /><path d="m9 12 2.1 2.1L15 10.2" /></svg></span>
                    <span class={mobileMenuLabelClass(questsActive)}>{ui.navQuests}</span>
                  </a>
                  <Link href="/profile" class={mobileMenuItemClass(profileActive)} aria-current={profileActive ? "page" : undefined}>
                    <span class="mobile-menu-item-icon" aria-hidden="true"><svg viewBox="0 0 24 24" role="presentation"><circle cx="12" cy="8.25" r="3.15" /><path d="M5.25 19.5c1.65-3.3 4.2-4.95 6.75-4.95s5.1 1.65 6.75 4.95" /></svg></span>
                    <span class={mobileMenuLabelClass(profileActive)}>{ui.navProfile}</span>
                  </Link>
                </nav>
              </aside>
            </details>
